...
function init(){
 ...
 function aplicar(){
  var q=norm(campo&&campo.value), per=periodo?periodo.value:'hoje', ft=fonte?fonte.value:'todas', n=0;
  ...
  if(aviso){aviso.hidden=n!==0; aviso.textContent=per==='hoje'?'Nenhuma menção publicada hoje nas fontes monitoradas. Tente “Últimos 7 dias”.':'Nenhuma menção corresponde aos filtros escolhidos.';}
 }
